...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 13, 2022 at 02:30 PM
...
CREATE TABLE `produk` (
  ...
  `barcode_barang` int(11) NOT NULL,
...
ALTER TABLE `produk`
  ...
  ADD KEY `barcode_barang` (`barcode_barang`),
...
--
ALTER TABLE `barang`
  MODIFY `barcode` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `produk`
  ADD CONSTRAINT `produk_ibfk_1` FOREIGN KEY (`barcode_barang`) REFERENCES `barang` (`barcode`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `produk_ibfk_2` FOREIGN KEY (`id_makanan`) REFERENCES `makanan` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
